...
public class HistoryActivity extends AppCompatActivity {
    private HistorySQLiteHelper mHistorySQLiteHelper = new HistorySQLiteHelper(this);
    ...
    private void initListView() {
        ...
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                View dialog = LayoutInflater.from(HistoryActivity.this).inflate(R.layout.delete_or_no,null);
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                int delete_collect =db.delete(mHistorySQLiteHelper.getTableName(),"title=?",new String[]{title});
                                if(delete_collect!=0){
                                    initData();
    ...
    private void initData() {
        data.clear();
        SQLiteDatabase db = mHistorySQLiteHelper.getReadableDatabase();
        mCursor = db.query(mHistorySQLiteHelper.getTableName(),new String[]{"*"},null,null,null,null,null);
